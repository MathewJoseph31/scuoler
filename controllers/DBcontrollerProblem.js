...
exports.editProblemInDB = async function (req, res, next) {
  ...
  var sql =
    ...
    " p_solution:=$4, p_answerkey:=$5, p_quizes_id:=$6, p_categories_id:=$7, p_type:=$8, p_problem_open:=$9, p_solution_open:=$10);";
...
exports.getProblems = async function (req, res, next) {
  ...
  var sql =
    ...
    " A.solution, A.type, A.problem_open, A.solution_open, A.author_id, A.source, A.author_name, A.view_count " +
