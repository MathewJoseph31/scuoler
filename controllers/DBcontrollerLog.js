...
exports.getWebLogs = async function (req, res, next) {
  ...
  let filterBots = queryObject.filterBots;
  ...
  // console.log(filterBots + ", currPage " + currentPage);
  ...
  var sql = `
      select 
          ...
          user_agent,
          log_filename 
    from web_logs_get(p_startDateTime:=$1, p_endDateTime:=$2, p_filterBot:=$3, p_offset:=$4, p_limit:=$5) 
      `;
  pool.query(
    sql,
    [dt_startDateTime_utc, dt_endDateTime_utc, filterBots, offset, pageSize],
