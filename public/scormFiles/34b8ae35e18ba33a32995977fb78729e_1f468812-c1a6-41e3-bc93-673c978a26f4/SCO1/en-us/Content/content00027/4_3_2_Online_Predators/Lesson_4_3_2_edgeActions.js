...
//Edge binding end
Symbol.bindTriggerAction(compId,symbolName,"Default Timeline",0,function(sym,e){sym.getComposition().getStage().lessonSetText("The internet is a great way to meet new people. Be careful, though, even though they may seem nice you don't really know who they are or what their intentions are.");});
//Edge binding end
...
Symbol.bindTriggerAction(compId,symbolName,"Default Timeline",0,function(sym,e){sym.getComposition().getStage().lessonSetText("The internet is a great way to meet new people. Be careful, though, even though they may seem nice you don't really know who they are or what their intentions are.");});
//Edge binding end
Symbol.bindTriggerAction(compId,symbolName,"Default Timeline",0,function(sym,e){sym.getComposition().getStage().lessonSetText("The Internet is a great way to meet new people. Be careful, though―even though a person might seem nice and trustworthy, you don't really know who they are or what their intentions are.");});
//Edge binding end
})("Slide01");
...
(function(symbolName){Symbol.bindTriggerAction(compId,symbolName,"Default Timeline",0,function(sym,e){var element=sym.$("StartText").html("Online Predators");});
//Edge binding end
})("StartScreen");
...
//Edge symbol: 'YvetteStanding'
(function(symbolName){})("YvetteStanding");
//Edge symbol end:'YvetteStanding'
...
(function(symbolName){Symbol.bindTriggerAction(compId,symbolName,"Default Timeline",0,function(sym,e){sym.getComposition().getStage().lessonSetText("Some people create false online identities and pretend to be someone else. People who use false identities to mislead others into inappropriate or dangerous interactions are known as online predators.");});
//Edge binding end
...
(function(symbolName){Symbol.bindTriggerAction(compId,symbolName,"Default Timeline",0,function(sym,e){sym.getComposition().getStage().lessonSetText("Children are often the target of online predators. They can manipulate young people's trust and relative inexperience at identifying online threats from stangers.");});
//Edge binding end
...
//Edge symbol: 'YvettePointing'
(function(symbolName){})("YvettePointing");
//Edge symbol end:'YvettePointing'

//=========================================================

//Edge symbol: 'Slide01_1'
(function(symbolName){Symbol.bindTriggerAction(compId,symbolName,"Default Timeline",0,function(sym,e){sym.getComposition().getStage().lessonSetText("Adults are also targets, typically for financial exploitation, and can often be just as naïve when it comes to knowing the identity of who they are interacting with online.");});
//Edge binding end
...
//Edge symbol: 'MoneyFlyUp'
(function(symbolName){Symbol.bindTriggerAction(compId,symbolName,"Default Timeline",1250,function(sym,e){sym.play("Loop");});
//Edge binding end
})("MoneyFlyUp");
//Edge symbol end:'MoneyFlyUp'

//=========================================================

//Edge symbol: 'Slide01_1'
(function(symbolName){Symbol.bindTriggerAction(compId,symbolName,"Default Timeline",0,function(sym,e){sym.getComposition().getStage().lessonSetText("Chat rooms, discussion boards, emails and even instant messages are all places where online predators try and make contact with people. Even if someone looks like a regular person, remember they may be assuming a false identity to trick you.");});
//Edge binding end
Symbol.bindTriggerAction(compId,symbolName,"Default Timeline",6250,function(sym,e){sym.play("Loop");});
//Edge binding end
Symbol.bindTriggerAction(compId,symbolName,"Default Timeline",7500,function(sym,e){sym.getComposition().getStage().lessonNextSlide();});
//Edge binding end
Symbol.bindSymbolAction(compId,symbolName,"creationComplete",function(sym,e){sym.slideExit=function(){sym.play("Exit");};});
//Edge binding end
})("Slide05");
...
(function(symbolName){Symbol.bindTriggerAction(compId,symbolName,"Default Timeline",0,function(sym,e){var element=sym.$("StartText").html("Now you know the basics of avoiding online predators. Close this window to return to the course.");});
//Edge binding end
})("EndScreen");
...
//Edge symbol: 'YvetteBlink'
(function(symbolName){Symbol.bindTriggerAction(compId,symbolName,"Default Timeline",6900,function(sym,e){sym.play("Loop");});
//Edge binding end
})("YvetteBlink");
//Edge symbol end:'YvetteBlink'

//=========================================================

//Edge symbol: 'YvetteStanding_1'
(function(symbolName){})("YvetteStandingConcerned");
//Edge symbol end:'YvetteStandingConcerned'

//=========================================================

//Edge symbol: 'YvetteBlink_1'
(function(symbolName){Symbol.bindTriggerAction(compId,symbolName,"Default Timeline",6900,function(sym,e){sym.play("Loop");});
//Edge binding end
})("YvetteBlinkSide");
//Edge symbol end:'YvetteBlinkSide'

//=========================================================

//Edge symbol: 'YvettePointing_1'
(function(symbolName){})("YvettePointingConcerned");
//Edge symbol end:'YvettePointingConcerned'
})(jQuery,AdobeEdge,"EDGE-60082980");
// SIG // Begin signature block
// SIG // MIIauwYJKoZIhvcNAQcCoIIarDCCGqgCAQExCzAJBgUr
// SIG // DgMCGgUAMGcGCisGAQQBgjcCAQSgWTBXMDIGCisGAQQB
// SIG // gjcCAR4wJAIBAQQQEODJBs441BGiowAQS9NQkAIBAAIB
// SIG // AAIBAAIBAAIBADAhMAkGBSsOAwIaBQAEFJ1O0Z6XDpoU
// SIG // HWEgmgOXMd5DsAGdoIIVgjCCBMMwggOroAMCAQICEzMA
...
// SIG // BgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEWBBQbMt2S1kYL
// SIG // Sx0N8HCPAsYMjr/0fjBeBgorBgEEAYI3AgEMMVAwTqAm
// SIG // gCQATQBpAGMAcgBvAHMAbwBmAHQAIABMAGUAYQByAG4A
// SIG // aQBuAGehJIAiaHR0cDovL3d3dy5taWNyb3NvZnQuY29t
// SIG // L2xlYXJuaW5nIDANBgkqhkiG9w0BAQEFAASCAQBGV85K
// SIG // TumtnWl8VeDsRa5IZkNQXGELDRC9KUm+0Fni4d8r7sRf
// SIG // l4kfLy7VMj9m70y9BsnJf5GGoBgXQ+wPbAmt+wd7fSEL
// SIG // swI6lc4i8ero5dt8xDtVyXiGJhboQNq/Q0ZlpOB1mcS1
// SIG // EMCTp4FbOKO8OSpDf1BjwxwL9ZzQJIXpRCJmrTWNxsPn
// SIG // HG199n0sItTziiix0if4wxZEBdErYfFjIr4EFaoNESou
// SIG // nlYZDb3fyWwagDtfzDjoQshAhzaGHZBmD9i6nYykGy0q
// SIG // ImhnEwymYTz8yi8B0FwDsGUF4dIi5RaCrqmP5upGX1Ey
// SIG // 6UM+pBlQe9BtaIec9H7UB61BBY2PoYICKDCCAiQGCSqG
...
// SIG // WjAjBgkqhkiG9w0BCQQxFgQU6B/iyseFQ/a1wND+W+oz
// SIG // TOsCI/MwDQYJKoZIhvcNAQEFBQAEggEAKMARWzEALFsx
// SIG // pZg5d886sIPkboe/urWkLlLux++JqiTFuiA4k2eiuZnm
// SIG // T+f6EZeHfkbygpcierXnOiVIfASqE7if5c5wSjrBeRpV
// SIG // 3NcYMWeugYzJwMrJpuDAqRot186kttl5dOBm/DT3k1Rg
// SIG // ur5mGQvhHNqPbLk03nf41dF+v0cjEzU0AhohgAb9rQ/G
// SIG // 5VR0hWmS6b+W11u4MaoUGnHZ8g9i11F8Ru0b8nusVhGi
// SIG // hQpc4Fx/+kYzitRxacbQUfFaKbl2F+U1g/w5/+v53LrD
// SIG // u6CXwlAOsB+i29pCK/nVgy4zr9SnykJjNnftZr15dI2T
// SIG // cBTUdVlGzRRqQbt5BXzkQQ==
